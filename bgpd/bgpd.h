...
#define BGP_CONFIG_DAMPENING              (1 << 0)
  ...
  */
  struct bgp_maxpaths_cfg maxpaths[AFI_MAX][SAFI_MAX];
};
...
// added by MODORI on 20210923
  /* Remote router Name Prefix. */
  char * remote_name;
  /* Local router Name Prefix. */
  char * local_name;

// added by MODORI on 20211026
	uint64_t face_id;
...
/* BGP Router name size.  */
#define BGP_ROUTER_NAME_SIZE	1024
...
/* DCN BGP finite state machine events.  */
#define NDN_connection_open                      3
#define NDN_connection_closed                    4
#define NDN_connection_open_failed               5
#define NDN_fatal_error                          6
...
//20211201 by modori
#define BGP_DEFAULT_CONFIG             "dbgpd.conf"
...
//added by MODORI on 20210923
extern struct peer *dcn_peer_lookup (struct bgp *, const char *);
...
extern struct peer *peer_lookup_with_open (union sockunion *, as_t, struct in_addr *,
				    int *);
// added by chahn
extern int dcn_bgp_nexthop_set (struct bgp_nexthop *, struct peer *);
...
extern int bgp_router_name_static_set (struct bgp *, const char *);

extern int bgp_cluster_id_set (struct bgp *, struct in_addr *);
extern int dcn_bgp_cluster_id_set (struct bgp *, const char *);
...
//added by MODORI on 20211027
//extern int dcn_peer_remote_as (struct bgp *, const char*, as_t *, afi_t, safi_t, uint64_t);
extern int dcn_peer_remote_as (struct bgp *, const char*, as_t *, afi_t, safi_t, const char*);
