...
bgp_scan_init (void)
{
  ...
  // NDN
  cache1_table[AFI_NDN] = bgp_table_init (AFI_NDN, SAFI_NDN);
  bgp_nexthop_cache_table[AFI_NDN] = cache1_table[AFI_NDN];
  bgp_connected_table[AFI_NDN] = bgp_table_init (AFI_NDN, SAFI_NDN);
}
