...
extern int bgp_nlri_parse_ndn (struct peer *, struct attr *, struct bgp_nlri *);
...
// addec by chahn
extern void dcn_bgp_redistribute_add (struct prefix *,
				  u_int32_t, u_char, route_tag_t);
extern void dcn_bgp_redistribute_delete (struct prefix *, u_char);
extern void dcn_bgp_redistribute_withdraw (struct bgp *, afi_t, int);
...
// added by chahn
extern int dcn_bgp_update (struct peer *, struct prefix *, struct attr *,
		       afi_t, safi_t, int, int, struct prefix_rd *, 
		       u_char *, int);
