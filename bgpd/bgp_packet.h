...
extern int dcn_bgp_write (struct peer *);

//Added by MODORI on 20210910
int bgp_read_from_dcn (struct peer * , uint8_t , size_t, const uint8_t *);
int bgp_redistribute_from_dcn (const char *, size_t, bool);
int bgp_write_to_dcn (char * to, uint8_t *);
