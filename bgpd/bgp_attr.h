...
struct attr_extra
{
  ...
  // added by chahn
  char originator_name[PREFIX_NAME_LEN];
...
extern bgp_size_t bgp_packet_attribute (struct bgp *bgp, struct peer *,
					...
					u_char *);
// added by chahn
extern bgp_size_t dcn_bgp_packet_attribute (struct bgp *bgp, struct peer *,
					struct stream *, struct attr *,
					struct prefix *, afi_t, safi_t,
					struct peer *, struct prefix_rd *,
					u_char *);
...
extern int cluster_loop_check (struct cluster_list *, char *);
