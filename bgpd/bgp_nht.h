...
// added by chahn
extern void dcn_bgp_nexthop_update (char *nexthop_name, uint64_t *face_id, uint8_t nexthop_num);
...
// added by chahn
int dcn_bgp_ensure_nexthop (struct bgp_info *, struct peer *, int connected);
