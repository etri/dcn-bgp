	  ...
	  int syslog_flags, int syslog_facility)
{
  ...
  zl = (struct zlog *)XCALLOC(MTYPE_ZLOG, sizeof (struct zlog));
...
static struct zebra_desc_table command_types[] = {
#if 0
  [ZEBRA_INTERFACE_ZERO]={ ZEBRA_INTERFACE_ZERO, "ZEBRA_INTERFACE_ADD", '\0' },
  [ZEBRA_INTERFACE_ADD]={ ZEBRA_INTERFACE_ADD, "ZEBRA_INTERFACE_ADD", '\0' },
  [ZEBRA_INTERFACE_DELETE]={ ZEBRA_INTERFACE_DELETE, "ZEBRA_INTERFACE_DELETE", '\0' },
  [ZEBRA_INTERFACE_UP]={	ZEBRA_INTERFACE_UP, "ZEBRA_INTERFACE_UP", '\0' },
  [ZEBRA_INTERFACE_DOWN]={	ZEBRA_INTERFACE_DOWN, "ZEBRA_INTERFACE_DOWN", '\0' },
  [ZEBRA_IPV4_ROUTE_ADD]={	ZEBRA_IPV4_ROUTE_ADD, "ZEBRA_IPV4_ROUTE_ADD", '\0' },
  [ZEBRA_IPV4_ROUTE_DELETE]={	ZEBRA_IPV4_ROUTE_DELETE, "ZEBRA_IPV4_ROUTE_DELETE", '\0' },
  [ZEBRA_IPV6_ROUTE_ADD]={	ZEBRA_IPV6_ROUTE_ADD, "ZEBRA_IPV6_ROUTE_ADD", '\0' },
  [ZEBRA_IPV6_ROUTE_DELETE]={	ZEBRA_IPV6_ROUTE_DELETE, "ZEBRA_IPV6_ROUTE_DELETE", '\0' },
  [ZEBRA_REDISTRIBUTE_ADD]={	ZEBRA_REDISTRIBUTE_ADD, "ZEBRA_REDISTRIBUTE_ADD", '\0' },
  [ZEBRA_REDISTRIBUTE_DELETE]={	ZEBRA_REDISTRIBUTE_DELETE, "ZEBRA_REDISTRIBUTE_DELETE", '\0' },
  [ZEBRA_REDISTRIBUTE_DEFAULT_ADD]={	ZEBRA_REDISTRIBUTE_DEFAULT_ADD, "ZEBRA_REDISTRIBUTE_DEFAULT_ADD", '\0' },
  [ZEBRA_REDISTRIBUTE_DEFAULT_DELETE]={	ZEBRA_REDISTRIBUTE_DEFAULT_DELETE, "ZEBRA_REDISTRIBUTE_DEFAULT_DELETE", '\0' },
  [ZEBRA_IPV4_NEXTHOP_LOOKUP]={	ZEBRA_IPV4_NEXTHOP_LOOKUP, "ZEBRA_IPV4_NEXTHOP_LOOKUP", '\0' },
  [ZEBRA_IPV6_NEXTHOP_LOOKUP]={	ZEBRA_IPV6_NEXTHOP_LOOKUP, "ZEBRA_IPV6_NEXTHOP_LOOKUP", '\0' },
  [ZEBRA_IPV4_IMPORT_LOOKUP]={	ZEBRA_IPV4_IMPORT_LOOKUP, "ZEBRA_IPV4_IMPORT_LOOKUP", '\0' },
  [ZEBRA_IPV6_IMPORT_LOOKUP]={	ZEBRA_IPV6_IMPORT_LOOKUP, "ZEBRA_IPV6_IMPORT_LOOKUP", '\0' },
  [ZEBRA_INTERFACE_RENAME]={	ZEBRA_INTERFACE_RENAME, "ZEBRA_INTERFACE_RENAME", '\0' },
  [ZEBRA_ROUTER_ID_ADD]={	ZEBRA_ROUTER_ID_ADD, "ZEBRA_ROUTER_ID_ADD", '\0' },
  [ZEBRA_ROUTER_ID_DELETE]={	ZEBRA_ROUTER_ID_DELETE, "ZEBRA_ROUTER_ID_DELETE", '\0' },
  [ZEBRA_ROUTER_ID_UPDATE]={	ZEBRA_ROUTER_ID_UPDATE, "ZEBRA_ROUTER_ID_UPDATE", '\0' },
  [ZEBRA_ROUTER_ID_UPDATE]={	ZEBRA_HELLO, "ZEBRA_HELLO", '\0' },
  [ZEBRA_HELLO]={	ZEBRA_NEXTHOP_REGISTER, "ZEBRA_NEXTHOP_REGISTER", '\0' },
  [ZEBRA_NEXTHOP_REGISTER]={	ZEBRA_NEXTHOP_UNREGISTER, "ZEBRA_NEXTHOP_UNREGISTER", '\0' },
  [ZEBRA_NEXTHOP_UPDATE]={	ZEBRA_NEXTHOP_UPDATE, "ZEBRA_NEXTHOP_UPDATE", '\0' },
#endif
#if 0
