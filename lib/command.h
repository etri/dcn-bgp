...
enum node_type 
{
  ...
  ///* added by MODORI 20210818 */
  //NDN_NODE,
  /* added by MODORI 20210910 */
  BGP_NDN_NODE,		/* BGP NDN unicast address family.  */
  BGP_NDNM_NODE,		/* BGP NDN multicast address family.  */
...
#define NEIGHBOR_I_CMD2      "neighbor internal (A.B.C.D|X:X::X:X|WORD) "
#define NEIGHBOR_E_CMD2      "neighbor external (A.B.C.D|X:X::X:X|WORD) "
